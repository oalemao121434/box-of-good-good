...
if(mysqli_num_rows($seleciona) <= 0){
    ...
    while($res = mysqli_fetch_assoc($seleciona)){
        ...
        echo '<li><strong><i class="fas fa-hashtag"></i> ID:</strong> ' . $res['id'] . ' |
              <a href="moderar.php?acao=excluir&id=' . $res['id'] . '"><i class="fas fa-trash"></i> Remover</a> |
              <a href="moderar.php?acao=editar&id=' . $res['id'] . '"><i class="fas fa-edit"></i> Modificar</a></li>';
        echo '<li><strong><i class="fas fa-user"></i> Nome:</strong> ' . htmlspecialchars($res['nome']) . '</li>';
        echo '<li><strong><i class="fas fa-envelope"></i> Email:</strong> ' . htmlspecialchars($res['email']) . '</li>';
        echo '<li><strong><i class="fas fa-comment"></i> Mensagem:</strong> ' . nl2br(htmlspecialchars($res['mensagem'])) . '</li>';
        echo '</ul>';
    }
}
?>
